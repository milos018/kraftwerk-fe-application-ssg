  ...
  <section class="flex flex-col items-center gap-5 p-4 md:px-[49px] py-[40px]">
    ...
    <form class="w-full flex flex-col lg:flex-row gap-5">
      ...
      <section class="bg-[#ECF1F5] flex flex-col lg:w-1/2 font-bold gap-5 p-5">
        ...
        <!-- Firstname + Surname -->
        <form-group label="first-name" type="text" text="First Name:" ph="First Name" />
        <form-group label="surname" type="text" text="Surname:" ph="Surname" />
        <!-- ZIP/City -->
        <div class="flex justify-between gap-2">
          <form-group label="zip" type="text" text="ZIP:" ph="ZIP" class="w-1/2" />
          <form-group label="city" type="text" text="City:" ph="City" class="w-1/2" />
        </div>
        <!-- Countries -->
      ...
      <section class="bg-[#ECF1F5] flex flex-col gap-5 font-bold lg:w-1/2 p-5">
        ...
        <div class="flex flex-col gap-2">
          ...
          <textarea
            class="resize-none block w-full h-[104px] p-2 rounded-md border-2 solid border-gray-200"
            placeholder="Message"
          ></textarea>
        </div>
        <!-- Send Button -->
